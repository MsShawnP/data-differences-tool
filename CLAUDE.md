...
---
# data-differences-tool — Project Context for Claude

## What this project is

A web application that compares two tabular data files (CSV, XLSX) and
produces a human-readable diff report. Designed for non-technical users
who need to reconcile spreadsheets — analysts, consultants, ops, finance,
auditors. Upload two files, pick key columns, get a clear summary of
what changed.

**Business question this project answers:** What specifically changed
between these two versions of this data, explained in plain language?
